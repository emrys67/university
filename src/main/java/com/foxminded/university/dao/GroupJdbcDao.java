...
public class GroupJdbcDao implements GroupDao {
    ...
    public void update(Group group) {
        ...
        if (success) {
            logger.info("Group with id {} has been updated", group.getId());
        } else {
